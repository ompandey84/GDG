...
const Card = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => (
    <div
      ref={ref}
      className={cn(
        "rounded-xl border border-white/10 bg-[var(--color-surface)] text-white shadow-sm overflow-hidden",
        className
      )}
      {...props}
    />
...
// Specific variant for glassmorphism
const GlassCard = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => (
    <div
      ref={ref}
      className={cn(
        "rounded-xl border border-white/20 bg-[var(--color-glass)] backdrop-blur-md text-white shadow-xl overflow-hidden",
        className
      )}
      {...props}
    />
